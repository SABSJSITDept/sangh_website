...
<header>
  ...
  <div class="header-left">
    <img src="{{ asset('images/mslogo.png') }}" alt="Logo" style="height: 60px; width: 60px; object-fit: contain;">
    <h4 class="mb-0 fw-bold"></h4>
  </div>

  <!-- Center: Title -->
  <h2 class="mb-0 text-center flex-grow-1" style="text-align: center;">Mahila Samiti Dashboard Panel</h2>

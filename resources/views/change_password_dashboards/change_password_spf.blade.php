...
@section('content')
        ...
        <form id="passwordForm" action="{{ route('password.update') }}" method="POST" novalidate>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input autocomplete="current-password" type="password" id="current_password" name="current_password"
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input autocomplete="new-password" type="password" id="new_password" name="new_password"
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input autocomplete="new-password" type="password" id="new_password_confirmation"
    ...
    <div class="toast-container position-fixed bottom-0 end-0 p-3" style="z-index: 10800;">
        <div id="passwordToast" class="toast align-items-center text-white border-0" role="alert" aria-live="polite"
            aria-atomic="true">
            <div class="d-flex">

...
<div class="container my-5">
    <h2 class="mb-4 text-center">📜 Mahila Samiti Notifications</h2>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function loadLast30Days() {
        fetch(`/api/notifications/filter?group=Mahila Samiti`)
            .then(res => res.json())
            .then(data => {
    ...
    document.getElementById("btnFetchYearMonth").addEventListener("click", () => {
        ...
        fetch(`/api/notifications/filter?group=Mahila Samiti&year=${year}&month=${month}`)
            .then(res => res.json())

...
@section('content')
            ...
            <div class="col-md-5 mb-4">
                <div class="card shadow-lg border-0 rounded-4"
                    ...
                    <div class="card-header text-white fw-bold border-0 py-3">
                        <h5 class="mb-0">
                            <i class="fas fa-file-pdf me-2"></i>📄 VP/SEC PDF अपलोड करें
                        </h5>
                    </div>
                    <div class="card-body bg-white rounded-bottom-4">
                        <form id="vpSecPdfForm" enctype="multipart/form-data">
                            @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Form Submit Handler
            document.getElementById('vpSecPdfForm').addEventListener('submit', async function (e) {
                e.preventDefault();
                const form = e.target;
                const formData = new FormData(form);
                const id = document.getElementById('editId').value;
                const url = id ? `/api/vp-sec-pdf/${id}` : '/api/vp-sec-pdf';
        ...
        // Reset Form
        function resetForm() {
            document.getElementById('vpSecPdfForm').reset();

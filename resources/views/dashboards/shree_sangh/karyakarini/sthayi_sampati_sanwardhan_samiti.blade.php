...
<style>
    ...
    h2 { text-align: center; font-weight: 700; color: #0d6efd; margin-bottom: 30px; }
    .card-form { background: #fff; padding: 25px; border-radius: 12px; box-shadow: 0 6px 18px rgba(0,0,0,0.1); transition: 0.3s; }
    .card-form.edit-mode { border-left: 5px solid #ffc107; }
    .alert-info { background-color: #d1ecf1; color: #0c5460; font-weight: 500; }
    table tbody tr:hover { background-color: #f1f7ff; transition: 0.3s; }
    .btn-icon { display: flex; align-items: center; gap: 5px; }
    img.table-img { border-radius: 50%; object-fit: cover; height: 50px; width: 50px; }
</style>
...
<div class="container py-4">
    ...
    <div class="card-form" id="formCard">
        <form id="sampatiForm" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <input type="text" id="name" name="name" class="form-control form-control-lg" placeholder="नाम" required>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    <input type="text" id="city" name="city" class="form-control form-control-lg" placeholder="शहर" required>
                </div>
                <div class="col-md-2">
                    <input type="text" id="mobile_number" name="mobile_number" class="form-control form-control-lg" placeholder="मोबाइल नंबर" required>
                </div>
                <div class="col-md-3">

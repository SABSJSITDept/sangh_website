    ...
    <div class="container mt-4">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select id="pravarti" class="form-select" required>
                        ...
                        <option value="Pratikraman Sanyojika, Reporting System">Pratikraman Sanyojika, Reporting System
                        </option>
        ...
        <div class="mb-3">
            ...
            <div class="d-flex flex-wrap gap-2">
                <button class="btn btn-outline-primary" onclick="fetchPravarti('Kesariya Karyashala')">Kesariya
                    Karyashala</button>
                <button class="btn btn-outline-primary" onclick="fetchPravarti('Sangathan')">Sangathan</button>
                <button class="btn btn-outline-primary" onclick="fetchPravarti('Sarwadharmi Sahyog')">Sarwadharmi
                    Sahyog</button>
                <button class="btn btn-outline-primary" onclick="fetchPravarti('Yuvati Shakti')">Yuvati Shakti</button>
                <button class="btn btn-outline-primary"
                    onclick="fetchPravarti('Sadhumargi Womens Motivational Forum')">Sadhumargi Womens Motivational
                    Forum</button>
                <button class="btn btn-outline-primary" onclick="fetchPravarti('Parivaranjali')">Parivaranjali</button>
                <button class="btn btn-outline-primary" onclick="fetchPravarti('Samta Chhatravratti')">Samta
                    Chhatravratti</button>
                <button class="btn btn-outline-primary" onclick="fetchPravarti('Reporting System')">Reporting
                    System</button>
                <button class="btn btn-outline-primary" onclick="fetchPravarti('Shramanopasak Sanyojika')">Shramanopasak
                    Sanyojika</button>
                <button class="btn btn-outline-primary" onclick="fetchPravarti('International')">International</button>
                <button class="btn btn-outline-primary" onclick="fetchPravarti('Pratikraman Sanyojika')">Pratikraman
                    Sanyojika</button>
                <button class="btn btn-outline-primary" onclick="fetchPravarti('Sajjhayami Rao Saya')">Sajjhayami Rao
                    Saya</button>
